    ...
    return (
      <>
        ...
        <main className="w-[100vw] h-[100vh] p-4 bg-teal-50 flex flex-row">
            ...
            <header className="flex flex-row justify-between">
              <div className="flex flex-row">
                ...
                <div className="flex flex-col ml-3">
                  ...
                  <h2 className="text-sm leading-5 font-normal text-gray-400">
                    Avid lover of fruits and veggies.
                  </h2>
                </div>
              </div>
              ...
              <ul>
                <li className="h-10 rounded-t-xl border-gray-500 px-4 bg-gray-200 border-b-[1px] py-10 flex flex-row items-center">
                  ...
                  <div className=" ml-3">
                    ...
                    <h5 className="text-sm text-gray-600 leading-5 font-light">
                      The messages you sent are not very true
                    </h5>
                  </div>
                ...
                <li className="h-10 px-4 border-gray-500 border-b-[1px] py-10 flex flex-row items-center">
                  ...
                  <div className=" ml-3">
                    ...
                    <h5 className="text-sm text-gray-600 leading-5 font-light">
                      Selected messages will appear here
                    </h5>
                  </div>
                </li>
                <li className="h-10 px-4 border-gray-500 border-b-[1px] py-10 flex flex-row items-center">
          ...
          <main className="w-[100%] sm:w-[70%] p-1 sm:p-6 sm:pt-0 m-0 sm:m-6 mt-0 sm:ml-12">
            <header className="w-full flex flex-row items-center border-b-2 pb-3">
              ...
              <div className=" flex flex-row items-center justify-center ">
                ...
                <div className="hidden w-8 h-8 rounded-md cursor-pointer bg-blue-100 sm:flex flex-row justify-center items-center">
                  <IconContext.Provider value={{ color: "gray" }}>
                    <CiSearch></CiSearch>
                  </IconContext.Provider>
                </div>
                <div className="hidden w-8 h-8 rounded-md ml-3 cursor-pointer  bg-blue-100 sm:flex flex-row justify-center items-center">
                  <IconContext.Provider value={{ color: "gray" }}>
            ...
            <main className="max-h-[100vh] sm:h-[80vh] sm:max-h-[80vh] flex flex-row  w-full bg-blue-50 mt-3 rounded-md">
              <section className="chats w-[100%] sm:w-[40%] max-h-[78vh] sm:h-full flex flex-col border-r-2 p-4 pt-2 border-w-2 overflow-y-scroll">
                <div>
                  <div
                    onClick={() => {
                    ...
                    className="bg-white cursor-pointer h-8 w-full pr-10 mr-auto rounded-md p-2 flex flex-row items-center"
                  >
                    <div className="bg-blue-100 h-6 w-8 rounded-md flex flex-row items-center justify-center">
                      <IconContext.Provider
                    ...
                    <h2 className="ml-3 text-gray-800 text-sm ">
                      New conversation
                    </h2>
                  </div>
                  <div>
              ...
              <section className=" hidden w-0 sm:block sm:w-[60%]">
                <header className="w-[100%] h-fit flex flex-row items-center pt-2 px-2 border-b-2 pb-2">
                  <div className="mr-auto px-4 py-1 text-base h-8  w-fit rounded-md  bg-red-300 text-red-900">
                    {View.getChats(userData.uid) ? "undefined" : "Flay"}
                  </div>
                  <div className="icons flex flex-row items-center ">
                    <IconContext.Provider
                      value={{ color: "rgb(201, 201, 255)", size: "16px" }}
                    >
                ...
                <section className="h-[76%]">
                  <header className="p-1">
                    <h6 className="text-sm text-blue-300 ml-1">
                      Today, {` ${date}`}
                    </h6>
                    <h1 className="text-base font-semibold ml-1">
                      {View.getChats()
                        ? "Where to look for cheap brochure services"
                        : ""}
                    </h1>
                  </header>
                  <section className="chats flex flex-col p-4 h-[87%] overflow-scroll">
                    <Atext
                      me={true}
                      image={Image}
                      message="I will come over now"
                    ></Atext>
                    <Atext
                      me={false}
                      message={
                        "Please don't come over I am ill and my dad is also around"
                      }
                    ></Atext>
                    ...
                    <Atext
                      me={true}
                      image={Image}
                      message={"I know babe, I will not come."}
                    ></Atext>
                    <Atext
                      me={true}
                      image={Image}
                      message={"I will send some things over."}
                    ></Atext>
                    <Atext
                      me={true}
                      image={Image}
                      message={"Is that okay by you?"}
                    ></Atext>
                ...
                <footer className="flex flex-row w-full ">
                  <div className="flex flex-row items-center w-full mx-3">
                    <input
                      ...
                      className="text-blue-600 focus:outline-none placeholder-blue-400 px-4 bg-white rounded-l-full w-full h-10"
                      type="text"
                    ></input>
                    <span className="flex flex-row items-center bg-white p-1 rounded-r-full">
                      ...
                      <button className="h-fit sticky bottom-0 mx-2 flex flex-row items-center rounded-full w-fit p-[0.4rem] text-white bg-gray-600 text-sm">
